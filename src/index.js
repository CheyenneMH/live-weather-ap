            ...
            if (hours > 12) {
                ...
                function showCurrent(response) {
                    ...
                    if (description === "Clouds") {
                        ...
                        document.getElementById("weatherIconLarge").src = "media/raining.png";
                        document.body.style.backgroundImage = "url('media/raining.jpg')";
                        document.getElementById("displayBox").style.background = "linear-gradient(113deg, #9DC5BB 23%, #DEE5E5 49%, #304950 100%)"; 
                    } if (description === "Snow") {
                        document.getElementById("weatherIconLarge").src = "media/snowing.png";
                        document.body.style.backgroundImage = "url('media/snowing.jpg')";
                        document.getElementById("displayBox").style.background = "linear-gradient(113deg, #9DC5BB 23%, #DEE5E5 49%, #304950 100%)"; 
                    } if (description === "Thunderstorm") {
                        document.getElementById("weatherIconLarge").src = "media/thunderstorm.png";
